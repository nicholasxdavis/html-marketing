...
description: >
  Device frames and locked layouts: real, clay, outline, frameless phones,
  browser chrome, split and caption-top geometry.
---
...
| Class | When |
|-------|------|
| `.phone` | iPhone / Play portrait |
| `.phone.clay` | Soft, analog brands |
| `.phone.outline` | Poster sets |
